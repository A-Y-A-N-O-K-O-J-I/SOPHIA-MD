...
sophia({
  name: "gpp",
  description: "Updates the group profile picture with the quoted image.",
  execute: async function(sock, message, args) {
    ...
    if (quoted?.imageMessage) {
      try {
        ...
        await console.wa("> GROUP PROFILE PICTURE UPDATED SUCCESSFULLY", message);
      } catch (error) {
        console.log("gpp error:", error);
        await console.wa("_An error occurred while updating group picture_", message);
      }
    } else {
